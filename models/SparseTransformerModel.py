# This file contains Sparse Transformer network
# Inspired from EXPLICIT SPARSE TRANSFORMER: CONCENTRATED ATTENTION THROUGH EXPLICIT SELECTION
...
class SparseTransformerModel(AttModel):
    ...
    def __init__(self, opt):
        super(SparseTransformerModel, self).__init__(opt)
        self.opt = opt
